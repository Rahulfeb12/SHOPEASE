const homelist = (req, res) => {
  res.render("locations-list", {
    ...
    locations: [
      ...
      {
        name: "ShopEase Footwear",
        address: "Novotel Road, Gachibowli",
        rating: 4.1,
        facilities: ["Sandals", "Sports Shoes", "Formal Shoes", "Chapals"],
        distance: "7Km",
      },
      {
        ...
        rating: 4.7,
        facilities: ["mens wear", "womens wear", "kids wear"],
        distance: "3Km",
      },
      {
        name: "ShopEase Kitchen Utensils",
        address: "Benz Circle, T-Hub",
        rating: 3.7,
        facilities: ["Pressure Cookers", "Steel Bowls", "Induction Stove"],
        distance: "14Km",
      }
    ],
  });
...
const locationInfo = (req, res) => {
  res.render("location-info", {
    ...
    location: {
      ...
      facilities: ["Electronics", "Gadgets", "Accessories","sandals", " sports shoes", "casual shoes","chapals","men'swear", "women's wear", "kid's wear","pressure cooker", "steel bowls", "induction stove"],
